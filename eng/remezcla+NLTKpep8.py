...
posTags = 'CC', 'CD', 'DT', 'EX', 'FW', 'IN', 'JJ', 'JJR', 'JJS', 'LS', 'MD',
...
proxP11, proxP12, proxP13, proxP14, proxP15, proxP16, proxP17, proxP18, proxP19,
proxP20 = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},
{}, {}, {}
proxPlusLista = [proxP1, proxP2, proxP3, proxP4, proxP5, proxP6, proxP7, proxP8,
                 proxP9, proxP10, proxP11, proxP12, proxP13, proxP14, proxP15, proxP16, proxP17, proxP18,
                 proxP19, proxP20]
proxM1, proxM2, proxM3, proxM4, proxM5, proxM6, proxM7, proxM8, proxM9, proxM10,
proxM11, proxM12, proxM13, proxM14, proxM15, proxM16, proxM17, proxM18, proxM19,
proxM20  = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},
{}, {}, {}
proxMinusLista = [proxM1, proxM2, proxM3, proxM4, proxM5, proxM6, proxM7, proxM8,
                  proxM9, proxM10, proxM11, proxM12, proxM13, proxM14, proxM15, proxM16, proxM17, proxM18,
                  proxM19, proxM20]

proxPlusLista = proxPlusLista[:proxMaxDial]
proxMinusLista = proxMinusLista[:proxMaxDial]

gramProxP1, gramProxP2, gramProxP3, gramProxP4, gramProxP5, gramProxP6,
gramProxP7, gramProxP8, gramProxP9, gramProxP10, gramProxP11, gramProxP12,
gramProxP13, gramProxP14, gramProxP15, gramProxP16, gramProxP17, gramProxP18,
gramProxP19, gramProxP20 = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},
{}, {}, {}, {}, {}, {}, {}
gramProxPlusLista = [gramProxP1, gramProxP2, gramProxP3, gramProxP4, gramProxP5,
                     gramProxP6, gramProxP7, gramProxP8, gramProxP9, gramProxP10, gramProxP11,
                     gramProxP12, gramProxP13, gramProxP14, gramProxP15, gramProxP16, gramProxP17,
                     gramProxP18, gramProxP19, gramProxP20]
gramProxM1, gramProxM2, gramProxM3, gramProxM4, gramProxM5, gramProxM6,
gramProxM7, gramProxM8, gramProxM9, gramProxM10, gramProxM11, gramProxM12,
gramProxM13, gramProxM14, gramProxM15, gramProxM16, gramProxM17, gramProxM18,
gramProxM19, gramProxM20  = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},
{}, {}, {}, {}, {}, {}, {}
gramProxMinusLista = [gramProxM1, gramProxM2, gramProxM3, gramProxM4, gramProxM5,
                      gramProxM6, gramProxM7, gramProxM8, gramProxM9, gramProxM10, gramProxM11,
                      gramProxM12, gramProxM13, gramProxM14, gramProxM15, gramProxM16, gramProxM17,
                      gramProxM18, gramProxM19, gramProxM20]
...
def acceptWord(pLine, pLineNum, pLineNList, proxNum, proxNumList, nextWord,
               rhymeList, superBlackList, jumpProxList):
    ...
    return pLine, pLineNum, pLineNList, proxNum, proxNumList, expressList,
superBlackList, jumpProxList


def resetLine(pLine, pLEmps, pWord, pWEmps, superPopList, anteLine, rhymeList,
              blackList, firstPopList, jumpProxList):
    pLine, pLEmps, pWEmps, pLineNList, proxNumList, superPopList, expressList,
    blackList, firstPopList, jumpProxList = [], [], [], [], [], [], [], [], [], []
    pWord = str()
    ...
    for all in rhymeList:
        expressList.append(all)
    return runLine, pLine, pLEmps, pWord, pWEmps, pLineNum, pLineNList, proxNum,
proxNumList, superPopList, expressList, blackList, firstPopList, jumpProxList
...
def gramProxWords(proxList, pLine, runLine, proxNumList, pLNi, pLineNList,
                  proxMinDial, proxLib, gramProxLib, superPopList, lastList, superBlackList,
                  allLinesLine, preferredList, jumpProxList, startTimeM, startTimeH):
...
def startLiner(anteString, rhymeList):
    pLine, pLEmps, pWEmps, pLineNList, proxNumList, proxList, superPopList,
    superBlackList, expressList, subPunx, lastPunx, punxList, runList, blackList,
    sv1stSuperPop, sv1stSuperBlack, jumpProxList, preferredList, anteLine,
    runLine = [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [],
    [], [], []
...
def poemLiner(rhymeList, empKeyLet, anteString, startList, usedList, lastList,
              proxMinDial, metaBlackList, allLinesLine, startTimeM, startTimeH):
    pLine, pLEmps, pWEmps, pLineNList, proxNumList, proxList, superPopList,
    superBlackList, expressList, subPunx, lastPunx, punxList, runList, blackList,
    sv1stSuperPop, sv1stSuperBlack, jumpProxList, preferredList, pLLen, pLineNum,
    pLNi, proxNum, thisPLen, pWord, svPWord, result, anteLine, anteLEmps, anteLFono,
    anteLVocs, anteLCons, runLine, runLEmps, runLFono, runLVocs, runLCons = startLiner(
        anteString, rhymeList)
    while (pLEmps != empKeyLet[0:len(empKeyLet)]) and (len(pLEmps) < len(empKeyLet)):
        ...
        if len(runLine) > 0:
            ...
            while ((len(pLineNList) >= proxMinDial) or (thisPLen < proxMinDial)) or (len(runLine) > 0):
                if len(superPopList) == 0:
                    superPopList, firstPopList, proxNumList, pLNi, pLineNList, jumpProxList = gramProxWords(
                        proxList, pLine, runLine, proxNumList, pLNi, pLineNList, proxMinDial, proxPlusLista,
                        gramProxPlusLista, superPopList, lastList, superBlackList, allLinesLine, preferredList,
                        jumpProxList, startTimeM, startTimeH)
                    superIntLine = []
                    superBIntLine = []
            ...
            if len(pLine) == 0:
                pLEmps = ['2']
                while ((len(pLEmps) == 0) or (len(pWord) < 1) or (pWord in allPunx) or
                       (pLEmps[:len(pLEmps)] != empKeyLet[:len(pLEmps)])) and (((len(superPopList[-1]) != 0) and
                                                                                (len(superPopList) != 0)) or (len(firstPopList) != 0)):
            ...
            try:
                ...
                if (len(pLine) > 0) and (len(pWord) > 0):
                    ...
                    if (pWord in rhymeList) and (newEmps == empKeyLet[0:len(empKeyLet)]) and ((pWord not in quantumList) or (pLine[-1] not in quantumList)):
                        pLEmps = newEmps
                        pLELen = len(pLEmps)
                        pLine, pLineNum, pLineNList, proxNum, proxNumList, expressList, superBlackList,
                        jumpProxList = acceptWord(pLine, pLineNum, pLineNList, proxNum, proxNumList,
                                                  pWord, rhymeList, superBlackList, jumpProxList)
                        break
                        ...
                        if (punxCt == 0): ## or (pWord not in allPunx)
                            ...
                            jumpProxList = acceptWord(pLine, pLineNum, pLineNList, proxNum, proxNumList,
                                                      pWord, rhymeList, superBlackList, jumpProxList)
                            superPopList, firstPopList, proxNumList, pLNi, pLineNList,
                            jumpProxList = gramProxWords(proxList, pLine, runLine, proxNumList, pLNi,
                                                         pLineNList, proxMinDial, proxPlusLista,
                                                         gramProxPlusLista, superPopList, lastList,
                                                         superBlackList, allLinesLine, preferredList,
                                                         jumpProxList, startTimeM, startTimeH)
                            printSuperLines(pLine, superPopList, superBlackList, firstPopList, jumpProxList)
                            break
        ...
        if (len(expressList) == 0) and (len(firstPopList) == 0) and (pLLen == len(pLine) and (len(superPopList[-1]) == 0)):
            if len(runLine) > 0:
                ...
                break
        elif (len(pLEmps) == len(empKeyLet)) and (((len(rhymeList) > 0) and
                                                   (pLine[:-1] not in rhymeList)) or
                                                  (pLine[:-1] in nonEnders)):
            sliceWord = pLine.pop()
            sliceEmps = []
            superPopList.pop()
            superBlackList.pop()
        ...
        if ((len(pLineNList) < proxMinDial) and (len(pLine) >= proxMinDial)) or ((len(superPopList[-1]) == 0) and (len(firstPopList) == 0)):
            ...
            while ((len(superPopList[-1]) == 0) and (len(firstPopList) == 0)) and (len(pLine) > 0):
                ...
                if len(superPopList) == 0:
                    break
            if len(pLine) == 0:
                runLine, pLine, pLEmps, pWord, pWEmps, pLineNum, pLineNList, proxNum,
                proxNumList, superPopList, expressList, superBlackList, firstPopList,
                jumpProxList = resetLine(pLine, pLEmps, pWord, pWEmps, superPopList,
                                         anteLine, rhymeList, superBlackList, firstPopList,
                                         jumpProxList)
    ...
    if (len(pLineNList) < proxMinDial) and (len(pLEmps) < len(empKeyLet)):
        ...
        if (len(rhymeList) > 0):
            if (lastWord in rhymeList):
                ...
                if pLine[-1] not in midPunx:
                    for each in endPunx:
                        if each in proxP1[lastWord]:
                            pLine.append(each)
                            break
                pString, pLEmps, pLFono, pLVocs, pLCons = pLineToStringData(pLine,
                                                                            empKeyLet)
                for all in pLine:
                    if all not in allPunx:
                        usedList.append(all)
                ...
                runLine, pLine, pLEmps, pWord, pWEmps, pLineNum, pLineNList, proxNum,
                proxNumList, superPopList, expressList, blackList, firstPopList,
                jumpProxList = resetLine(pLine, pLEmps, pWord, pWEmps, superPopList,
                                         anteLine, rhymeList, blackList, firstPopList,
                                         jumpProxList)
...
def runLiner(rhymeMap, empKey, usedList, emps, firstWords, startTimeM,
             startTimeH):
    ...
    while len(writtenLines) < len(rhymeMap):
        ...
        if (stopTimeM > (startTimeM + 11)) or ((startTimeH != stopTimeH) and
            ...
            usedList = []
            usedList = runLiner(rhymeMap, empKey, usedList, emps, firstWords, startTimeM,
                                startTimeH)
        ...
        if cLineData[1] == '0':
            lastList = []
            oneString, startList, usedList, lastList, result, pLEmps = poemLiner(
                [], empKey[int(empKeyBits[cLineData[0]])], anteLine, startList, usedList,
                lastList, proxMinDial, metaBlackList, allLinesLine, startTimeM, startTimeH)
        else:
            iCt = int(0)
            ...
            while iCt < len(writtenLines):
                if rhymeMapData[iCt][0] == rhyPairLet:
                    ...
                    if len(rhymeList) >= (rhyLinesInt-1):
                        oneString, startList, usedList, lastList, result, pLEmps = poemLiner(
                            rhymeList, empKey[int(empKeyBits[cLineData[0]])], anteLine, startList, usedList,
                            lastList, proxMinDial, metaBlackList, allLinesLine, startTimeM, startTimeH)
                    else:
                        result = 'fail-1'
                iCt+=1
        ...
        if result == 'pass':
            ...
            if len(writtenLines) > 0:
                minusLine, fuckThis, cuntLickers, thisVarIrrelevant, toothFairy = pStringToLineData(
                    writtenLines.pop())
            ...
            while allPopInt != lastPopInt:
                minusLine, mothersPie, tRex, neverLand, jackHammer = pStringToLineData(
                    writtenLines.pop())
                for all in minusLine:
                    allLinesLine.pop()
                allPopInt+=1
